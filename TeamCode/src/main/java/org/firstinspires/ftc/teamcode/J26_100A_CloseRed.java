...
@Autonomous(name = "J26_100A_CloseRed", group = "Auto",preselectTeleOp = "26-75.5T-Full Control")
public class J26_100A_CloseRed extends LinearOpMode {
    ...
    /* ================= LAUNCH TUNING ================= */
    static final double LAUNCH_RPM = 2500;
    ...
    /* ================= PATH ================= */
    void buildPath() {
        steps.add(Step.move(-48,  0, 0.6));
        steps.add(Step.launch());
        steps.add(Step.move(-8,   0, 0.7));

        steps.add(Step.rotate(-140));   // was +140

        steps.add(Step.move(-12,  0, 0.5));
        steps.add(Step.intakeOn());

        steps.add(Step.move(-32,  0, 0.3));
        steps.add(Step.move(44,   0, 0.6));
        ...
        steps.add(Step.move(16,  -16, 0.6)); // strafe inverted
    }

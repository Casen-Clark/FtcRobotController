...
@Autonomous(name = "J26_100A_FarRed", group = "Auto",preselectTeleOp = "26-75.5T-Full Control")
public class J26_100A_FarRed extends LinearOpMode {
    ...
    steps.add(Step.rotate(20));     // was -20
    steps.add(Step.launch());
    steps.add(Step.intakeOff());
    steps.add(Step.rotate(-20));    // was +20

    // 1st spike mark (mirrored)
    steps.add(Step.move(24, 0, 0.6));
    steps.add(Step.rotate(-92));    // was +92
    ...
    steps.add(Step.rotate(20));     // was -204wq   
    steps.add(Step.launch());
    steps.add(Step.intakeOff());
